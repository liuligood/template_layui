...
?>
    ...
    <form class="layui-form layui-row" id="add" action="<?=Url::to(['warehouse/create'])?>">
        ...
        <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="warehouse_name" lay-verify="required" placeholder="请输入供应商仓库名称" class="layui-input" style="width: 270px">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="warehouse_code"  placeholder="请输入供应商仓库编码" class="layui-input" style="width: 270px">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <?= Html::dropDownList('country',null,CountryService::getSelectOption(),
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <?= Html::dropDownList('eligible_country[]',null,CountryService::getSelectOption(),
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <?= Html::dropDownList('status',null,\common\models\warehousing\WarehouseProvider::$status_maps,
                        ['lay-ignore'=>'lay-ignore','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search','style' => 'width:270px']) ?>
                </div>
            </div>
