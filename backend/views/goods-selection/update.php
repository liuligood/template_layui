...
<form class="layui-form layui-row" id="update_goods" action="<?=Url::to(['goods-selection/update'])?>">
    ...
    <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            <?= \yii\helpers\Html::dropDownList('platform_type',$info['platform_type'],\common\components\statics\Base::$goods_source,
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="platform_url" value="<?=$info['platform_url']?>" lay-verify="required" placeholder="请输入来源平台链接" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="goods_type" value="1" title="单体" <?=$info['goods_type']== 1?'checked="checked"':''?>><div class="layui-unselect layui-form-radio"><div>单体</div></div>
                <input type="radio" name="goods_type" value="2" title="多变体" <?=$info['goods_type']== 2?'checked="checked"':''?>><div class="layui-unselect layui-form-radio"><div>多变体</div></div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="status" value="1" title="待处理" <?=$info['status']== 1?'checked="checked"':''?>><div class="layui-unselect layui-form-radio"><div>单体</div></div>
                <input type="radio" name="status" value="2" title="已完成" <?=$info['status']== 2?'checked="checked"':''?>><div class="layui-unselect layui-form-radio"><div>多变体</div></div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?= \yii\helpers\Html::dropDownList('owner_id',$info['owner_id'],$owner_id->adminArr(),
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="quantity" value="<?=$info['quantity']?>" lay-verify="required" placeholder="请输入件数" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea type="text" name="remarks"  placeholder="请输入备注" class="layui-input" style="height:175px"><?=$info['remarks']?></textarea>
            </div>
        </div>
