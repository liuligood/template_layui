...
<head>
    ...
    <?php $this->registerCssFile( '/static/css/laylogin.css?v=0.0.1')?>
    <?php $this->head() ?>
</head>
<?php $this->beginBody() ?>
        ...
        <div class="layadmin-user-login" id="LAY-user-login" style="display: none;">
            ...
            <div class="layadmin-user-login-main">
                <div class="layadmin-user-login-box layadmin-user-login-header">
                    ...
                    <p style="font-size: 18px;"> <?=Yii::$app->name?></p>
                </div>
                <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                    <div class="layui-form-item">
                        <label class="layadmin-user-login-icon layui-icon layui-icon-username" for="LAY-user-login-username"></label>
                        <input value="" type="text" name="username" id="username" lay-verify="username"
                               placeholder="账号" class="layui-input">
                    </div>
                    <div class="layui-form-item">
                        <label class="layadmin-user-login-icon layui-icon layui-icon-password" for="LAY-user-login-password"></label>
                        <input value="" type="password" name="password" id="password" lay-verify="password"
