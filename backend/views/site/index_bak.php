        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:;">
                        <img src="<?=empty(Yii::$app->user->identity->head_img)?'/static/img/face.jpg':Yii::$app->user->identity->head_img?>" class="layui-circle userIconAs"
                             width="35" height="35">
...
<?=$this->registerJsFile("@adminPageJs/site/index.js?v=0.1")?>
