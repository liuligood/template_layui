...
<form class="layui-form layui-row" id="add" action="<?=Url::to(['buyer-account-transaction-log/recharge'])?>">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline layui-col-md3">
                                        ...
                                        <div class="layui-input-block">
                                            <?= Html::dropDownList('transaction_type', null, BuyerAccountTransactionService::$card_type_map,
