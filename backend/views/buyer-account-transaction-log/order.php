...
<form class="layui-form layui-row" id="add" action="<?=Url::to(['buyer-account-transaction-log/order'])?>">
                            ...
                            <div class="layui-field-box">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline layui-col-md4">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="type_id" placeholder="订单号" value="<?=$model['type_id']?>" class="layui-input">
                                        </div>
                                    </div>
