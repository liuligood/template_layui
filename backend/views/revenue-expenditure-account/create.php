...
?>
    ...
    <form class="layui-form layui-row" id="add" action="<?=Url::to(['revenue-expenditure-account/create'])?>">
        ...
        <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="account" lay-verify="required" placeholder="请输入收支账号" class="layui-input ">
                </div>
            </div>
