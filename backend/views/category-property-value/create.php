...
<form class="layui-form layui-row" id="add" action="<?=Url::to(['category-property-value/create'])?>">
    ...
    <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="property_value" lay-verify="required" placeholder="请输入属性名称" class="layui-input" style="width: 220px">
            </div>
        </div>
