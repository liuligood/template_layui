...
?>
    ...
    <form class="layui-form layui-row" id="add" action="<?= Url::to(['promote-campaign/update']) ?>">
        ...
        <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline" style="width: 200px">
                    <?= \yii\helpers\Html::dropDownList('type', $info['type'], PromoteCampaign::$type_maps,
            ...
            <div class="layui-form-item layui-col-md6">
                ...
                <div class="layui-input-block">
                    <input type="text" name="promote_id" value="<?=$info['promote_id']?>"  placeholder="请输入推广活动编号" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-col-md6">
                ...
                <div class="layui-input-block">
                    <input type="text" name="promote_name" value="<?=$info['promote_name']?>" placeholder="请输入推广活动名称" class="layui-input">
                </div>
            </div>
