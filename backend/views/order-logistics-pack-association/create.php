...
<div class="lay-search">
    ...
    <div class="layui-inline">
        ...
        <?= Html::dropDownList('OrderSearch[source]', $searchModel['source'], Base::$platform_maps,
            ['lay-ignore'=>'lay-ignore','data-placeholder' => '全部','prompt' => '全部','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search','style'=>'width:185px','id'=>'platform']) ?>
    </div>
    <div class="layui-inline">
        店铺
    ...
    <div class="layui-inline">
        <label>发货时间</label>
        <input  class="layui-input search-con ys-date" name="OrderSearch[start_delivery_time]" value="<?=$searchModel['start_delivery_time'];?>"  id="start_date" autocomplete="off">
    </div>
    <span class="layui-inline layui-vertical-20">
        -
    </span>
    <div class="layui-inline layui-vertical-20">
        <input  class="layui-input search-con ys-date" name="OrderSearch[end_delivery_time]" value="<?=$searchModel['end_delivery_time'];?>" id="end_date" autocomplete="off">
    </div>
    <div class="layui-inline layui-vertical-20">
...
<form class="layui-form layui-row" id="add" action="<?=Url::to(['order-logistics-pack-association/assign'])?>">
...
?>
<?=$this->registerJsFile("@adminPageJs/order-logistics-pack-association/create.js?v=0.0.7")?>