...
<form class="layui-form layui-row" id="update-order" action="<?=Url::to(['buy-goods/change-status'])?>">
                            ...
                            <div class="layui-field-box">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <?php } else{ ?>
                                            <label class="layui-form-label" style="width: 120px;text-align: left"><?=$model['buy_goods_price']?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="layui-field-box">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline layui-col-md4">
                                        ...
                                        <?php if(in_array($model['buy_goods_status'],[BuyGoods::BUY_GOODS_STATUS_BUY])){ ?>
                                        <div class="layui-input-block">
