...
<form class="layui-form layui-row" id="update-order" action="<?=Url::to(['buy-goods/after-sale'])?>">
                        ...
                        <div class="layui-field-box">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <label class="layui-form-label" style="width: 140px;text-align: left">                                        <?= empty($model['platform_type'])?'':\common\components\statics\Base::$buy_platform_maps[$model['platform_type']]; ?>
                                    </label>
                                </div>
                        ...
                        <div class="layui-card-body">
                            ...
                            <div class="layui-field-box">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <label class="layui-form-label">申请售后时间</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="after_sale_time" id="date" placeholder="yyyy-MM-dd" autocomplete="off"  value="<?=$model['after_sale_time']?>" class="layui-input ys-date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline layui-col-md4">
                                        ...
                                        <label class="layui-form-label" style="width: 120px;text-align: left"><?=$model['buy_relation_no']?></label>
                                    </div>

                                    <div class="layui-inline layui-col-md4">
                                        <label class="layui-form-label">刷单买家号机器编号</label>
                                        <label class="layui-form-label" style="width: 120px;text-align: left"><?=$model['swipe_buyer_id']?></label>
                                    </div>
                                </div>

                                <?php if(in_array($model['buy_goods_status'],[BuyGoods::BUY_GOODS_STATUS_BUY,BuyGoods::BUY_GOODS_STATUS_DELIVERY])){ ?>
                                <div class="layui-form-item">
                                    <div class="layui-inline layui-col-md4">
                                        <label class="layui-form-label">亚马逊物流单号</label>
                                        <label class="layui-form-label" style="width: 120px;text-align: left"><?=$model['logistics_id']?></label>
                                    </div>

                                    <div class="layui-inline layui-col-md4">
                                        <label class="layui-form-label">预计到货时间</label>
                                        <label class="layui-form-label" style="width: 120px;text-align: left"><?=$model['arrival_time']?></label>
                                    </div>
                                </div>
                                <?php } ?>

                                <?php if($model['buy_goods_status'] == BuyGoods::BUY_GOODS_STATUS_DELIVERY){ ?>
                                <div class="layui-form-item">
                                    <div class="layui-inline layui-col-md4">
                                        <label class="layui-form-label">物流渠道</label>
                                        <label class="layui-form-label" style="width: 120px;text-align: left"><?=empty($model['logistics_channels_id'])?'':\common\models\Order::$logistics_channels_map[$model['logistics_channels_id']]?></label>
                                    </div>

                                    <div class="layui-inline layui-col-md4">
                                        <label class="layui-form-label">物流订单号</label>
                                        <label class="layui-form-label" style="width: 120px;text-align: left"><?=$model['track_no']?></label>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
