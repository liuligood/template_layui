...
<form class="layui-form layui-row" id="grab_goods" action="<?=Url::to(['financial-platform-sales-period/change?id='.$model['id']])?>">
    <div class="layui-col-md9 layui-col-xs12" style="padding: 0 10px">
        ...
        <div class="layui-form-item layui-col-md10" style="width: 430px;padding-top: 30px;">
            ...
            <div class="layui-input-block">
                <textarea type="text" name="remark"  placeholder="请输入备注" style="height: 100px;" class="layui-input"></textarea>
            </div>
        </div>
