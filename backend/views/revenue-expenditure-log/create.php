...
?>
    ...
    <form class="layui-form layui-row" id="updates" action="<?=Url::to(['revenue-expenditure-log/create'])?>">
        ...
        <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
            ...
            <div class="layui-form-item" style="margin-left: 40px;width: 1500px;">
                ...
                <div class="layui-inline" style="margin-right: 25px">
                    <input  class="layui-input" name="money" lay-verify="required" autocomplete="off">
                </div>

                收支账号
                <div class="layui-inline">
                    <?= Html::dropDownList('revenue_expenditure_account_id', null,RevenueExpenditureAccount::getAllAccount(),
            ...
            <div class="layui-form-item" style="margin-left: 40px;width: 1500px;">
                ...
                收支类型
                <div class="layui-inline" style="margin-left: 10px">
                    <?= Html::dropDownList('revenue_expenditure_type', null,RevenueExpenditureType::getAllType(),
                        ['lay-ignore'=>'lay-ignore','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search' ]) ?>
                </div>

                转账
                <div class="layui-inline" style="margin-right: 25px">
                    <?= Html::dropDownList('payment_back', null,RevenueExpenditureLog::$payment_back_maps,
                        ['lay-ignore'=>'lay-ignore','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search' ]) ?>
                </div>

                核查
                <div class="layui-inline">
                    <?= Html::dropDownList('examine', null,RevenueExpenditureLog::$examine_maps,
                        ['lay-ignore'=>'lay-ignore','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search' ]) ?>
                </div>

                报销人
                <div class="layui-inline">
                    <?= Html::dropDownList('reimbursement_id',null,\common\models\Reimbursement::getAllReimbursement(),
                        ['lay-ignore'=>'lay-ignore','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search' ]) ?>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea  name="desc"  placeholder="请输入描述" class="layui-textarea" style="width: 330px"></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item" style="padding-left: 20px">
                ...
                <div class="layui-inline">
                    <div class="layui-upload ys-upload-img-multiple" data-number="10">
                        ...
                        <input type="hidden" name="images"  class="layui-input" >
