...
<form class="layui-form layui-row" id="category_update" action="<?=Url::to(['independence-category/create'])?>">
    ...
    <div class="layui-col-md9 layui-col-xs12" style="padding-top: 15px">
            ...
            <div class="layui-inline layui-col-md6">
                ...
                <div class="layui-input-block">
                    <div class="rc-cascader">
                        <input class="layui-input" type="text" id="category_id" name="category_id" style="display: none;" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline layui-col-md6">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" placeholder="请输入类目名称" class="layui-input ">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline layui-col-md6">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name_en" placeholder="请输入类目EN名称"  class="layui-input ">
                </div>
            </div>
        </div>
