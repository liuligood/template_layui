...
<div class="layui-col-md9 layui-col-xs12" style="margin:10px 20px 30px 20px">
    <form class="layui-form layui-row" id="grab_goods" action="<?=Url::to(['goods/examine?'.$uri])?>">
        <div class="layui-col-md9 layui-col-xs12" style="padding: 0 10px">
            <div class="layui-inline">
                ...
                <div class="layui-input-block" style="width: 1000px">
                    <?php
                    $type_map = \common\models\Goods::$goods_tort_type_map;
                    unset($type_map[0]);
                    foreach ($type_map as $item_k=>$item_v) { ?>
                        <input type="radio" name="goods_tort_type" value="<?=$item_k?>" title="<?=$item_v?>" <?php if(isset($goods['goods_tort_type']) && $item_k == $goods['goods_tort_type']){ echo 'checked'; } ?>>
                    <?php }?>
                </div>
            </div>
            ...
            <div class="layui-form-item" style="margin-top: 10px">
                <div class="layui-input-block">
                    ...
                    <a href="<?=Url::to(['goods/examine?goods_no='.$prev_goods_no.'&'.$uri])?>" class="layui-btn">上一条</a>
                    <?php }?>
