...
<form class="layui-form layui-row" id="grab_goods" action="<?=Url::to(['goods/claim?goods_no='.$goods_no])?>">
        ...
        <div class="layui-form-item">
            <div class="layui-inline layui-col-md6">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="checkbox" name="shop[]" value="<?=$k?>" lay-skin="primary" title="<?=$v?>" <?php if(in_array($k,$shop_ids)){ ?>checked="" disabled="" <?php }?>>
                    <?php }?>
                </div>
            </div>
        </div>
