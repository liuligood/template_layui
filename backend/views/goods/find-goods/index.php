    ...
    <div class="layui-card">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li <?php if($tag == FindGoods::FIND_GOODS_STATUS_UNTREATED){?>class="layui-this" <?php }?>><a href="<?=Url::to(['find-goods/index?tag='.FindGoods::FIND_GOODS_STATUS_UNTREATED])?>">未完善</a></li>
                <li <?php if($tag == FindGoods::FIND_GOODS_STATUS_NORMAL){?>class="layui-this" <?php }?>><a href="<?=Url::to(['find-goods/index?tag='.FindGoods::FIND_GOODS_STATUS_NORMAL])?>">正常</a></li>
            </ul>
        </div>
        <div class="lay-lists">
            <form>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-card-body">
                <table id="goods" class="layui-table" lay-data="{url:'<?=Url::to(['find-goods/list?tag='.$tag.'&source_method='.$source_method])?>', height : 'full-210',method :'post', cellMinWidth : 95, page:{limits:[20, 50, 100, 500, 1000]}, limit : 20}" lay-filter="goods">
                    <thead>
                    <tr>
