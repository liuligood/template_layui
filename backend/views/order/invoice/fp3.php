...
<table style="width: 800px;">
    <tr>
        ...
        <td width="280"></td>
        <td align="right">
            <img src="static/other/images/3_logo.png" width="200" border="0" />
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td colspan="3">
            <div>
                <p>USt-IdNr. DE335339475</p>
                <p>Hangzhou Hanfei Trading Co., Ltd.</p>
                <p>No. 2111, 2nd Floor, Building 2, No. 1298, Danonggang Road, Jianggan District, Hangzhou City, Zhejiang Province 310016</p>
            </div>
        </td>
    </tr>
</table>
