...
<table style="width: 800px;">
    <tr>
        ...
        <td width="280"></td>
        <td align="right">
            <img src="static/other/images/cye_logo.png" width="200" border="0" />
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td colspan="3">
            <div>
                <p>USt-IdNr. DE330244160</p>
                <p>Shenzhen Chengying International Trade Co., Ltd.</p>
                <p>1510-1511-60, Block A, Jiahe Huaqiang Building, Shennan Road, Huaqiangbei Street, Futian District, Shenzhen </p>
            </div>
        </td>
    </tr>
</table>
