    ...
    <div class="layui-card">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li <?php if($tag == 10){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=10'])?>">全部</a></li>
                <li <?php if($tag == 1){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=1'])?>">未确认 <span class="span-circular-red"><?=$order_count[1]?></span></a></li>
                <li <?php if($tag == 2){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=2'])?>">待处理 <span class="span-circular-red"><?=$order_count[2]?></span></a></li>
                <li <?php if($tag == 5){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=5'])?>">待发货 <span class="span-circular-red"><?=$order_count[5]?></span></a></li>
                <li <?php if($tag == 6){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=6'])?>">已发货 <span class="span-circular-red"><?=$order_count[6]?></span></a></li>
                <li <?php if($tag == 11){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=11'])?>">已完成</a></li>
                <li <?php if($tag == 7){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=7'])?>">已取消</a></li>
                <li <?php if($tag == 12){?>class="layui-this" <?php }?>><a href="<?=Url::to(['order/overseas-index?tag=12'])?>">已退款</a></li>
            </ul>
        </div>
                ...
                <form class="layui-form">
                    <blockquote class="layui-elem-quote quoteBox">
                        <div class="layui-inline">
                            <a class="layui-btn" data-type="url" data-title="人工录单" data-url="<?=Url::to(['order/create?overseas=1'])?>" data-callback_title = "订单列表" >人工录单</a>
                        </div>
                    </blockquote>
                </form>
                <form class="layui-form">
                    <div class="lay-search">
                        ...
                        <div class="layui-inline">
                            <label>子商品编号</label>
                            <textarea name="OrderSearch[cgoods_no]" class="layui-textarea search-con" style="height: 39px; min-height:39px"><?=$searchModel['cgoods_no'];?></textarea>
                        </div>
                        <div class="layui-inline">
                            <label>商品名称</label>
                        ...
                        <div class="layui-inline">
                            仓库
                            <?= Html::dropDownList('OrderSearch[warehouse]', $searchModel['warehouse'], $overseas_list,
                                ['lay-ignore'=>'lay-ignore','prompt' => '全部','class'=>'layui-input search-con ys-select2' ,'lay-search'=>'lay-search','style'=>'width:185px' ]) ?>
                        </div>
                        <?php if($tag == 7){?>
                            <div class="layui-inline">
                ...
                <div>
                    <div class="layui-form" style="margin-top: 10px">
                        ...
                        <?php if(in_array($tag,[2,8])){?>
                            ...
                            <div class="layui-inline">
                                <a class="layui-btn layui-btn-sm layui-btn-normal" id="js-logistics-channels" data-title="批量选择物流方式"  data-url="<?=Url::to(['order/batch-logistics-channels?type=2'])?>" >批量选择物流方式</a>
                            </div>
                        <?php }?>
                    ...
                    <div class="layui-form">
                        <table class="layui-table" style="text-align: center">
                            ...
                            <?php else: foreach ($list as $k => $v):
                                $i = 0;
                                $platform_name = \common\components\statics\Base::$platform_maps[$v['source']];
                            ...
                            <?= $goods_v['stock_occupy'] != 1?'缺':'有';?>
                                        ...
                                        <a class="layui-btn layui-btn-xs layui-btn-a" data-width="550px" data-type="url" data-url="<?=Url::to(['/goods-'.$url_platform_name.'/overseas-index'])?>?sku_no=<?=$sku_no?>" data-title="海外仓" style="color: #00a0e9;margin: 0px"><i class="layui-icon layui-icon-website"></i></a>
                                        <br/>
                            ...
                            <?=empty($goods_v['asin_count'])?'':$goods_v['asin_count']?>
                                    ...
                                    <?php if($i == 1):?>
                                        ...
                                        <td align="left" rowspan="<?=$v['goods_count']?>">
                                            ...
                                            仓库：<?=empty($overseas_list[$v['warehouse']]) ? '' : $overseas_list[$v['warehouse']]?>
                                        ...
                                        <td align="left" rowspan="<?=$v['goods_count']?>" style="width:250px;word-wrap: break-word;word-break: break-all;">
                                            ...
                                            <?php if($v['track_no']){ ?>
                                                ...
                                                <?php }?>
                                                <br/><?php } ?>
                                            <?php if($v['delivery_order_id']){ ?>平台单号：<?= $v['delivery_order_id'] ?><br/><?php } ?>
