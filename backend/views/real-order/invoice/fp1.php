...
<table style="width: 800px;">
    <tr>
        ...
        <td width="380"></td>
        <td align="right">
            <img src="static/other/images/2_logo.png" width="200" border="0" />
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td align="left" colspan="3">
            <p>Datum <?=$model['invoice_no']?></p>
            <p>Bestellnummer  <?=$model['order_id']?></p>
            <p> </p>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            ...
            <table border="1" style="line-height: 20px;text-align: center">
                ...
                <tr>
                    ...
                    <th width="120">Umsatzsteuer 16%(EUR)</th>
    ...
    <tr>
        <td colspan="3">
            <div>
                <p>USt-IdNr. DE332946103</p>
                <p>Meizhou Xinqianfeng Architectural Decoration Engineering Co., Ltd.</p>
                <p>wuhuaxianxianchenggongyequjinchengdadao(yuanshuitanlu)luohuduan</p>
                <p>changfang（hongmuchanyeyuanBquB3hao)  514433</p>
            </div>
        </td>
    </tr>
</table>
