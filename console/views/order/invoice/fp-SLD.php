...
<table style="width: 800px;">
    <tr>
        ...
        <td width="280"></td>
        <td align="right">
            <img src="static/other/images/sld_logo.png" width="200" border="0" />
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td colspan="3">
            <div>
                <p>USt-IdNr. DE338840392Q</p>
                <p>Zhongshan Sanlindou Network Technology Co., Ltd</p>
                <p>B427, 4th Floor, Phase 2, No. 88 Rainbow Avenue, West District, Zhongshan City 528400</p>
            </div>
        </td>
    </tr>
</table>
